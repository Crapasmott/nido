  ...
  const blogPosts = [
    {
      ...
      enlace: '/blog/post/?slug=afirmaciones-post-parto'
    },
    {
      id: 2,
      ...
      enlace: '/blog/post/?slug=el-cierre-de-los-40-dias-un-ritual-de-renacimiento-y-sanacion'
    }
  ];
          ...
          {blogPosts.map(post => (
            <div key={post.id} className="relative overflow-hidden rounded-xl shadow-lg group">
              ...
              <div className="absolute bottom-0 left-0 p-6 w-full">
                ...
                <a 
                  href={post.enlace} 
                  className="inline-flex w-12 h-12 bg-[#e1ccad] rounded-full items-center justify-center text-[#00927c] transition-transform group-hover:translate-x-2"
                >
